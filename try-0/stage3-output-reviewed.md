...
{
  "plane_id": "b1",
  "uuid": null,   // for unique identification (future use)
  "label": "Plane A1",
  "network-id": null,   // for association (future use)
  "zLevel": 1,              // relative units  
  "corners": {
...
```json
{
  ...
  "name": "S01",
  "plane_id": "b1",
  "network-uuid": null,   // for unique parent identification (future use)
  "lat": -6.4892,
  "lon": -76.3634,
  "radius": 0.2,
  "color": "#800080",
  "state": "green",
  "colorOverride": null    // null = inherit plane color; or "red", "orange", "darkgray"  
  "terminationPoints": [
    {
      "tp-id": "tp1",
      "uuid": null,   // for unique identification (future use)  
      "sphere_id": "S01",
      "node-uuid": null,   // for unique parent identification (future use)      
      "name": "TP-A1-1",
      "label": "Optical Port 1",
      "color": "green",
      "vector": [0.1, 0.9, -0.3]   // relative direction (for 3D protrusion)
    }
   ]
}
```
...
```json
{
  ...
  "color": "green",
  "from_tp": "TP1",
  "from_tp_uuid": null,   // for unique tp identification (future use)
  "to_tp": "TP2",
  "to_tp_uuid": null,   // for unique tp identification (future use)    
  "colorOverride": null  
}
```
